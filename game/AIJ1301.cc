...
void dfs3(const vector<vector<char> > &tablero, int i, int j, int &x1, int &y1, int &distance, char c1, char c2, char c3) {
  int n = tablero.size();
  int m = tablero[0].size();
  vector< vector <bool> > vist(n, vector<bool>(m, false));
  queue <pair <pair <int, int>, int> > q;
...
virtual void play () {
  ...
  if (is_night()) {
    for (int id : b) { //action of all builders
      ...
      if (citizen(id).life < builder_ini_life()) {
        if (food_nearby) move(id,food_dir);
          ...
          int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
          if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and tablero[p.i - 1][p.j] != 'x' and tablero[p.i - 1][p.j] != 'p' and tablero[p.i - 1][p.j] != 'w' and tablero[p.i - 1][p.j] != 'G' and tablero[p.i - 1][p.j] != 'P') {
            dfs4(tablero, i0, j0, x0, y0, d0, 'F', 'F', 'M');
            distancias.insert(make_pair(d0, make_pair(x0, y0)));
          }
          if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and tablero[p.i + 1][p.j] != 'x' and tablero[p.i + 1][p.j] != 'p' and tablero[p.i + 1][p.j] != 'w' and tablero[p.i + 1][p.j] != 'G' and tablero[p.i + 1][p.j] != 'P') {
            dfs4(tablero, i1, j1, x1, y1, d1, 'F', 'F', 'M');
            distancias.insert(make_pair(d1, make_pair(x1, y1)));
          }
          if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and tablero[p.i][p.j - 1] != 'x' and tablero[p.i][p.j - 1] != 'p' and tablero[p.i][p.j - 1] != 'w' and tablero[p.i][p.j - 1] != 'G' and tablero[p.i][p.j - 1] != 'P') {
            dfs4(tablero, i2, j2, x2, y2, d2, 'F', 'F', 'M');
            distancias.insert(make_pair(d2, make_pair(x2, y2)));
          }
          if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and tablero[p.i][p.j + 1] != 'x' and tablero[p.i][p.j + 1] != 'p' and tablero[p.i][p.j + 1] != 'w' and tablero[p.i][p.j + 1] != 'G' and tablero[p.i][p.j + 1] != 'P') {
            dfs4(tablero, i3, j3, x3, y3, d3, 'F', 'F', 'M');
            distancias.insert(make_pair(d3, make_pair(x3, y3)));
          }
          auto it = distancias.begin();
          if (it->first == d3 and it->first != 0) {
        ...
        if (money_nearby) move(id,money_dir);
          ...
          int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
          if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and tablero[p.i - 1][p.j] != 'x' and tablero[p.i - 1][p.j] != 'p' and tablero[p.i - 1][p.j] != 'w' and tablero[p.i - 1][p.j] != 'G' and tablero[p.i - 1][p.j] != 'P') {
            dfs4(tablero, i0, j0, x0, y0, d0, 'M', 'M', 'M');
            distancias.insert(make_pair(d0, make_pair(x0, y0)));
          }
          if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and tablero[p.i + 1][p.j] != 'x' and tablero[p.i + 1][p.j] != 'p' and tablero[p.i + 1][p.j] != 'w' and tablero[p.i + 1][p.j] != 'G' and tablero[p.i + 1][p.j] != 'P') {
            dfs4(tablero, i1, j1, x1, y1, d1, 'M', 'M', 'M');
            distancias.insert(make_pair(d1, make_pair(x1, y1)));
          }
          if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and tablero[p.i][p.j - 1] != 'x' and tablero[p.i][p.j - 1] != 'p' and tablero[p.i][p.j - 1] != 'w' and tablero[p.i][p.j - 1] != 'G' and tablero[p.i][p.j - 1] != 'P') {
            dfs4(tablero, i2, j2, x2, y2, d2, 'M', 'M', 'M');
            distancias.insert(make_pair(d2, make_pair(x2, y2)));
          }
          if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and tablero[p.i][p.j + 1] != 'x' and tablero[p.i][p.j + 1] != 'p' and tablero[p.i][p.j + 1] != 'w' and tablero[p.i][p.j + 1] != 'G' and tablero[p.i][p.j + 1] != 'P') {
            dfs4(tablero, i3, j3, x3, y3, d3, 'M', 'M', 'M');
            distancias.insert(make_pair(d3, make_pair(x3, y3)));
          }
          auto it = distancias.begin();
          if (it->first == d3 and it->first != 0) {
    ...
    for (int id : w) { //action of all warriors
      ...
      if (citizen(id).life == warrior_ini_life() and citizen(id).weapon == Bazooka) {
        if (builder_nearby) {
          move(id, builder_dir);
        }
      ...
      else if (citizen(id).life < warrior_ini_life() and citizen(id).weapon == Bazooka) {
        if (builder_nearby) {
          move(id, builder_dir);
        }
        else if (hammer_nearby) {
          ...
          if (it->first == d3 and it->first != 0) {
            ...
            int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
            if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and tablero[p.i - 1][p.j] != 'x' and tablero[p.i - 1][p.j] != 'P') {
              dfs5(tablero, i0, j0, x0, y0, d0, 'M', 'g', 'F');
              distancias.insert(make_pair(d0, make_pair(x0, y0)));
            }
            if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and tablero[p.i + 1][p.j] != 'x' and tablero[p.i + 1][p.j] != 'P') {
              dfs5(tablero, i1, j1, x1, y1, d1, 'M', 'g', 'F');
              distancias.insert(make_pair(d1, make_pair(x1, y1)));
            }
            if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and tablero[p.i][p.j - 1] != 'x' and tablero[p.i][p.j - 1] != 'P') {
              dfs5(tablero, i2, j2, x2, y2, d2, 'M', 'g', 'F');
              distancias.insert(make_pair(d2, make_pair(x2, y2)));
            }
            if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and tablero[p.i][p.j + 1] != 'x' and tablero[p.i][p.j + 1] != 'P') {
              dfs5(tablero, i3, j3, x3, y3, d3, 'M', 'g', 'F');
              distancias.insert(make_pair(d3, make_pair(x3, y3)));
            }
            auto it = distancias.begin();
            if (it->first == d3 and it->first != 0) {
      ...
      else if (citizen(id).life < warrior_ini_life() and citizen(id).weapon == Gun) {
        if (builder_nearby) {
          move(id, builder_dir);
        }
        else if (hammer_nearby) {
          ...
          if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and tablero[p.i - 1][p.j] != 'x' and tablero[p.i - 1][p.j] != 'P' and tablero[p.i - 1][p.j] != 'G') {
            dfs2(tablero, i0, j0, x0, y0, d0, 'w', 'F', 'p');
            distancias.insert(make_pair(d0, make_pair(x0, y0)));
          }
          if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and tablero[p.i + 1][p.j] != 'x' and tablero[p.i + 1][p.j] != 'P' and tablero[p.i + 1][p.j] != 'G') {
            dfs2(tablero, i1, j1, x1, y1, d1, 'w', 'F', 'p');
            distancias.insert(make_pair(d1, make_pair(x1, y1)));
          }
          if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and tablero[p.i][p.j - 1] != 'x' and tablero[p.i][p.j - 1] != 'P' and tablero[p.i][p.j - 1] != 'G') {
            dfs2(tablero, i2, j2, x2, y2, d2, 'w', 'F', 'p');
            distancias.insert(make_pair(d2, make_pair(x2, y2)));
          }
          if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and tablero[p.i][p.j + 1] != 'x' and tablero[p.i][p.j + 1] != 'P' and tablero[p.i][p.j + 1] != 'G') {
            dfs2(tablero, i3, j3, x3, y3, d3, 'w', 'F', 'p');
            distancias.insert(make_pair(d3, make_pair(x3, y3)));
          }
          auto it = distancias.begin();
          if (it->first == d3 and it->first != 0) {
            ...
            int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
            int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
            if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and tablero[p.i - 1][p.j] != 'x' and tablero[p.i - 1][p.j] != 'G' and tablero[p.i - 1][p.j] != 'P') {
              dfs2(tablero, i0, j0, x0, y0, d0, 'M', 'M', 'F');
              distancias.insert(make_pair(d0, make_pair(x0, y0)));
            }
            if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and tablero[p.i + 1][p.j] != 'x' and tablero[p.i + 1][p.j] != 'G' and tablero[p.i + 1][p.j] != 'P') {
              dfs2(tablero, i1, j1, x1, y1, d1, 'M', 'M', 'F');
              distancias.insert(make_pair(d1, make_pair(x1, y1)));
            }
            if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and tablero[p.i][p.j - 1] != 'x' and tablero[p.i][p.j - 1] != 'G' and tablero[p.i][p.j - 1] != 'P') {
              dfs2(tablero, i2, j2, x2, y2, d2, 'M', 'M', 'F');
              distancias.insert(make_pair(d2, make_pair(x2, y2)));
            }
            if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and tablero[p.i][p.j + 1] != 'x' and tablero[p.i][p.j + 1] != 'G' and tablero[p.i][p.j + 1] != 'P') {
      ...
      else if (citizen(id).life < warrior_ini_life() and citizen(id).weapon == Hammer) {
        if (builder_nearby) {
          move(id, builder_dir);
        }
        else if (hammer_nearby) {
          ...
          int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
          int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
          if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and tablero[p.i - 1][p.j] != 'x' and tablero[p.i - 1][p.j] != 'P' and tablero[p.i - 1][p.j] != 'G' and tablero[p.i - 1][p.j] != 'w') {
            dfs4(tablero, i0, j0, x0, y0, d0, 'M', 'F', 'p');
            distancias.insert(make_pair(d0, make_pair(x0, y0)));
          }
          if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and tablero[p.i + 1][p.j] != 'x' and tablero[p.i + 1][p.j] != 'P' and tablero[p.i + 1][p.j] != 'G' and tablero[p.i + 1][p.j] != 'w') {
            dfs4(tablero, i1, j1, x1, y1, d1, 'M', 'F', 'p');
            distancias.insert(make_pair(d1, make_pair(x1, y1)));
          }
          if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and tablero[p.i][p.j - 1] != 'x' and tablero[p.i][p.j - 1] != 'P' and tablero[p.i][p.j - 1] != 'G' and tablero[p.i][p.j - 1] != 'w') {
            dfs4(tablero, i2, j2, x2, y2, d2, 'M', 'F', 'p');
            distancias.insert(make_pair(d2, make_pair(x2, y2)));
          }
          if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and tablero[p.i][p.j + 1] != 'x' and tablero[p.i][p.j + 1] != 'P' and tablero[p.i][p.j + 1] != 'G' and tablero[p.i][p.j + 1] != 'w') {
            dfs4(tablero, i3, j3, x3, y3, d3, 'M', 'F', 'p');
            distancias.insert(make_pair(d3, make_pair(x3, y3)));
          }
          auto it = distancias.begin();
          if (it->first == d3 and it->first != 0) {
            ...
            int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
            if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and tablero[p.i - 1][p.j] != 'x' and tablero[p.i - 1][p.j] != 'P' and tablero[p.i - 1][p.j] != 'G' and tablero[p.i - 1][p.j] != 'w') {
              dfs4(tablero, i0, j0, x0, y0, d0, 'M', 'M', 'F');
              distancias.insert(make_pair(d0, make_pair(x0, y0)));
            }
            if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and tablero[p.i + 1][p.j] != 'x' and tablero[p.i + 1][p.j] != 'P' and tablero[p.i + 1][p.j] != 'G' and tablero[p.i + 1][p.j] != 'w') {
              dfs4(tablero, i1, j1, x1, y1, d1, 'M', 'M', 'F');
              distancias.insert(make_pair(d1, make_pair(x1, y1)));
            }
            if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and tablero[p.i][p.j - 1] != 'x' and tablero[p.i][p.j - 1] != 'P' and tablero[p.i][p.j - 1] != 'G' and tablero[p.i][p.j - 1] != 'w') {
              dfs4(tablero, i2, j2, x2, y2, d2, 'M', 'M', 'F');
              distancias.insert(make_pair(d2, make_pair(x2, y2)));
            }
            if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and tablero[p.i][p.j + 1] != 'x' and tablero[p.i][p.j + 1] != 'P' and tablero[p.i][p.j + 1] != 'G' and tablero[p.i][p.j + 1] != 'w') {
              dfs4(tablero, i3, j3, x3, y3, d3, 'M', 'M', 'F');
              distancias.insert(make_pair(d3, make_pair(x3, y3)));
            }
            auto it = distancias.begin();
            if (it->first == d3 and it->first != 0) {
