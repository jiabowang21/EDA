 ...
 */
#define PLAYER_NAME Gunnerv8888
  ...
  if (is_day()) { //during the day
    ...
    for (int id : b) { //action of all builders
      ...
      if (construir and i < 3) {
        ...
        Dir libre_dir = Down;
        for (Dir d : dirs) {
          if (pos_ok(p + d) and cell(p + d).type != Building and cell(p + d).b_owner == me()) {
            libre = true;
            libre_dir = d;
          }
    ...
    for (int id : w) { //action of all warriors
      ...
      if (perseguir) {
        ...
        else if (not hammer_nearby and (citizen(id).weapon == Gun or citizen(id).weapon == Bazooka)) {
           map<int, pair<int, int>> distancias;
          int i0 = p.i - 1, j0 = p.j, x0 = 0, y0 = 0, d0 = 0;
          int i1 = p.i + 1, j1 = p.j, x1 = 0, y1 = 0, d1 = 0;
          int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
        ...
        else if (not builder_nearby and citizen(id).weapon == Hammer) {
          map<int, pair<int, int>> distancias;
          int i0 = p.i - 1, j0 = p.j, x0 = 0, y0 = 0, d0 = 0;
          int i1 = p.i + 1, j1 = p.j, x1 = 0, y1 = 0, d1 = 0;
          int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
    ...
    for (int id : b) { //action of all builder
      ...
      if (i < 3) {
        ...
        for (Dir d : dirs) {
          if (pos_ok(p + d) and cell(p + d).type != Building and cell(p + d).b_owner == me() and cell(p + d).id == -1) {
            barricada_nearby = true;
            barricada_dir = d;
          }
        }
        if (barricada_nearby) move(id, barricada_dir);
        else if (not barricada_nearby and cell(p).b_owner == -1) {
          bool money_nearby = false;
          bool food_nearby = false;
          bool builder_nearby = false;
          bool hammer_nearby = false;
          ...
          if (bazooka_nearby or gunner_nearby or hammer_nearby) {
          ...
          else if (builder_nearby and citizen(id).life == builder_ini_life()) move(id, builder_dir);
          else if (food_nearby and citizen(id).life != builder_ini_life()) move(id, food_dir);
          else {
            map<int, pair<int, int>> distancias;
            int i0 = p.i - 1, j0 = p.j, x0 = 0, y0 = 0, d0 = 0;
            int i1 = p.i + 1, j1 = p.j, x1 = 0, y1 = 0, d1 = 0;
            int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
            int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
            if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and cell(Pos(i0, j0)).b_owner == -1 and tablero[p.i - 1][p.j] != 'p' and tablero[p.i - 1][p.j] != 'w' and tablero[p.i - 1][p.j] != 'G' and tablero[p.i - 1][p.j] != 'P') {
              dfs(tablero, i0, j0, x0, y0, d0, 'M', 'M', 'M');
              distancias.insert(make_pair(d0, make_pair(x0, y0)));
            }
            if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and cell(Pos(i1, j1)).b_owner == -1 and tablero[p.i + 1][p.j] != 'p' and tablero[p.i + 1][p.j] != 'w' and tablero[p.i + 1][p.j] != 'G' and tablero[p.i + 1][p.j] != 'P') {
              dfs(tablero, i1, j1, x1, y1, d1, 'M', 'M', 'M');
              distancias.insert(make_pair(d1, make_pair(x1, y1)));
            }
            if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and cell(Pos(i2, j2)).b_owner == -1 and tablero[p.i][p.j - 1] != 'p' and tablero[p.i][p.j - 1] != 'w' and tablero[p.i][p.j - 1] != 'G' and tablero[p.i][p.j - 1] != 'P') {
              dfs(tablero, i2, j2, x2, y2, d2, 'M', 'M', 'M');
              distancias.insert(make_pair(d2, make_pair(x2, y2)));
            }
            if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and cell(Pos(i3, j3)).b_owner == -1 and tablero[p.i][p.j + 1] != 'p' and tablero[p.i][p.j + 1] != 'w' and tablero[p.i][p.j + 1] != 'G' and tablero[p.i][p.j + 1] != 'P') {
              dfs(tablero, i3, j3, x3, y3, d3, 'M', 'M', 'M');
              distancias.insert(make_pair(d3, make_pair(x3, y3)));
            }
            auto it = distancias.begin();
    ...
    for (int id : w) { //action of all warriors
      ...
      if (citizen(id).weapon == Bazooka) {
        if (hammer_nearby) {
          ...
          int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
          int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
          if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and cell(Pos(i0, j0)).b_owner == -1) {
            dfs(tablero, i0, j0, x0, y0, d0, 'w', 'G', 'p');
            distancias.insert(make_pair(d0, make_pair(x0, y0)));
          }
          if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and cell(Pos(i1, j1)).b_owner == -1) {
            dfs(tablero, i1, j1, x1, y1, d1, 'w', 'G', 'p');
            distancias.insert(make_pair(d1, make_pair(x1, y1)));
          }
          if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and cell(Pos(i2, j2)).b_owner == -1) {
            dfs(tablero, i2, j2, x2, y2, d2, 'w', 'G', 'p');
            distancias.insert(make_pair(d2, make_pair(x2, y2)));
          }
          if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and cell(Pos(i3, j3)).b_owner == -1) {
        ...
        if (builder_nearby) {
        ...
        else if (bazooka_nearby or (gunner_nearby and citizen(id).life < warrior_ini_life())) {
          bool yes = false;
          Dir yes_direction = Up;
          for (Dir d : dirs) {
            if (pos_ok(p + d) and cell(p + d).id == -1 and cell(p + d).type != Building) {
          ...
          int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
          int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
          if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and cell(Pos(i0, j0)).b_owner == -1 and tablero[p.i - 1][p.j] != 'P') {
            dfs(tablero, i0, j0, x0, y0, d0, 'w', 'b', 'p');
            distancias.insert(make_pair(d0, make_pair(x0, y0)));
          }
          if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and cell(Pos(i1, j1)).b_owner == -1 and tablero[p.i + 1][p.j] != 'P') {
            dfs(tablero, i1, j1, x1, y1, d1, 'w', 'b', 'p');
            distancias.insert(make_pair(d1, make_pair(x1, y1)));
          }
          if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and cell(Pos(i2, j2)).b_owner == -1 and tablero[p.i][p.j - 1] != 'P') {
            dfs(tablero, i2, j2, x2, y2, d2, 'w', 'b', 'p');
            distancias.insert(make_pair(d2, make_pair(x2, y2)));
          }
          if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and cell(Pos(i3, j3)).b_owner == -1 and tablero[p.i][p.j + 1] != 'P') {
            dfs(tablero, i3, j3, x3, y3, d3, 'w', 'b', 'p');
            distancias.insert(make_pair(d3, make_pair(x3, y3)));
          }
          auto it = distancias.begin();
          if (it->first == d3 and it->first != 0) {
        ...
        if (builder_nearby) {
        ...
        else if (bazooka_nearby or gunner_nearby or (hammer_nearby and citizen(id).life < warrior_ini_life())) {
          bool yes = false;
          Dir yes_direction = Up;
          for (Dir d : dirs) {
          ...
          int i2 = p.i, j2 = p.j - 1, x2 = 0, y2 = 0, d2 = 0;
          int i3 = p.i, j3 = p.j + 1, x3 = 0, y3 = 0, d3 = 0;
          if (p.i > 0 and tablero[p.i - 1][p.j] != 'B' and tablero[p.i - 1][p.j] != 'e' and cell(Pos(i0, j0)).b_owner == -1 and tablero[p.i - 1][p.j] != 'P' and tablero[p.i - 1][p.j] != 'G') {
            dfs(tablero, i0, j0, x0, y0, d0, 'b', 'g', 'p');
            distancias.insert(make_pair(d0, make_pair(x0, y0)));
          }
          if (p.i < n - 1 and tablero[p.i + 1][p.j] != 'B' and tablero[p.i + 1][p.j] != 'e' and cell(Pos(i1, j1)).b_owner == -1 and tablero[p.i + 1][p.j] != 'P' and tablero[p.i + 1][p.j] != 'G') {
            dfs(tablero, i1, j1, x1, y1, d1, 'b', 'g', 'p');
            distancias.insert(make_pair(d1, make_pair(x1, y1)));
          }
          if (p.j > 0 and tablero[p.i][p.j - 1] != 'B' and tablero[p.i][p.j - 1] != 'e' and cell(Pos(i2, j2)).b_owner == -1 and tablero[p.i][p.j - 1] != 'P' and tablero[p.i][p.j - 1] != 'G') {
            dfs(tablero, i2, j2, x2, y2, d2, 'b', 'g', 'p');
            distancias.insert(make_pair(d2, make_pair(x2, y2)));
          }
          if (p.j < m - 1 and tablero[p.i][p.j + 1] != 'B' and tablero[p.i][p.j + 1] != 'e' and cell(Pos(i3, j3)).b_owner == -1 and tablero[p.i][p.j + 1] != 'P' and tablero[p.i][p.j + 1] != 'G') {
